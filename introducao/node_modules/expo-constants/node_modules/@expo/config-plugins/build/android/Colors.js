...
function assignColorValue(xml, { value, name, }) {
    if (value) {
        return setColorItem(Resources_1.buildResourceItem({
            name,
            value,
        }), xml);
    }
...
function getColorsAsObject(xml) {
    var _a;
    if (!((_a = xml === null || xml === void 0 ? void 0 : xml.resources) === null || _a === void 0 ? void 0 : _a.color)) {
        return null;
    }
    return Resources_1.getResourceItemsAsObject(xml.resources.color);
}
...
function getObjectAsColorsXml(obj) {
    return {
        resources: {
            color: Resources_1.getObjectAsResourceItems(obj),
        },
    };
}
