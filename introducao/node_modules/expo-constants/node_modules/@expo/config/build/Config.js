...
function getConfig(projectRoot, options = {}) {
    ...
    function fillAndReturnConfig(config, dynamicConfigObjectType) {
        ...
        if (options.isPublicConfig) {
            ...
            configWithDefaultValues.exp.currentFullName = getFullName_1.getFullName(configWithDefaultValues.exp);
            // @ts-ignore: originalFullName not on type yet.
            configWithDefaultValues.exp.originalFullName = getFullName_1.getFullName(configWithDefaultValues.exp);
        }
